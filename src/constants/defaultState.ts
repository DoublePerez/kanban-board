 ...
 * migration if needed.
 *
 * Tasks are ordered to follow the Shrek movie timeline.
 */

import type { AppState, Task } from "@/types";
import { DEFAULT_COLUMNS } from "@/constants";

/** Seed tasks for the default "Shrek is Love" project (movie chronological order). */
export const SEED_TASKS: Task[] = [
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: "00000000-0000-4000-b000-000000000002", text: "Sneak past the dragon in the keep", done: true },
  ...
  },
  {
    ...
    description: "Deliver the princess to Lord Farquaad",
    priority: "High",
    date: "Mar 3",
    dueDate: "2026-03-03",
    columnId: "todo",
    subtasks: [
      { id: "00000000-0000-4000-b000-000000000007", text: "Set up camp for the night", done: false },
      { id: "00000000-0000-4000-b000-000000000008", text: "Cook dinner with Donkey by the fire", done: false },
      { id: "00000000-0000-4000-b000-000000000009", text: "Navigate the road to Duloc", done: false },
    ],
  },
  {
...
export const DEFAULT_STATE: AppState = {
  projects: [
    { id: "00000000-0000-4000-a000-000000000101", name: "Shrek is Love", tasks: SEED_TASKS, columns: [...DEFAULT_COLUMNS], backgroundImage: null, accentColor: "lime" },
    { id: "00000000-0000-4000-a000-000000000102", name: "Work", tasks: [], columns: [...DEFAULT_COLUMNS], backgroundImage: null, accentColor: "lime" },
    { id: "00000000-0000-4000-a000-000000000103", name: "Personal", tasks: [], columns: [...DEFAULT_COLUMNS], backgroundImage: null, accentColor: "lime" },
  ],
